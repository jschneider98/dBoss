...
class User extends AbstractEntity
{
    ...
    public function isMyQuery($query_id = null)
    {
        ...
        //$query = Dboss_Model_DbTable_Row_Query::getRow($params);
        $query = true;
    ...
    public function isMyDatabase($database_id = null)
    {
        ...
        //$query = Dboss_Model_DbTable_Row_Database::getRow($params);
        $query = true;
    ...
    public function isMyServer($server_id = null)
    {
        ...
        //$query = Dboss_Model_DbTable_Row_Server::getRow($params);
        $query = true;
    ...
    public function getMyQuery($query_id = null)
    {
        ...
        //$params = array('where' => "user_id = {$this->user_id} AND query_id = {$query_id}");
        //return Dboss_Model_DbTable_Row_Query::getRow($params);
    }
    ...
    {
        // $role_db_row = Dboss_Model_DbTable_Row_Role::getOrCreateRow(array("where" => "role_id = " . $this->role_id));
